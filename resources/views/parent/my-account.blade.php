      ...
      <div class="container-fluid my-2">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 text-right">
            <a href="{{route('parent.dashboard')}}" class="btn btn-primary">Back</a>
          </div>
        </div>
      </div>
      <!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <textarea name="address" value={{old('address')}} id="address" cols="5" rows="2" class="form-control" placeholder="Address">{{$getRecord->address}}</textarea>
                   @error('address')
                  <span class="invalid-feedback">{{$message}}</span>
               @enderror
                </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" value="{{old('occupation',$getRecord->occupation)}}" name="occupation" id="occupation" class="form-control @error('occupation') is-invalid @enderror" placeholder="Occupation">	
                  @error('occupation')
                  <span class="invalid-feedback">{{$message}}</span>
               @enderror
                </div>
        ...
        <div class="pb-5 pt-3">
          ...
          <a href="{{route('parent.dashboard')}}" class="btn btn-outline-dark ml-3">Cancel</a>
        </div>
      </div>
      </form>
      </div>
