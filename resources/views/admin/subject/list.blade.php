...
<section class="content-header">					
  <div class="container-fluid my-2">
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <h1 class="heading">Subject List (Total: {{$subjects->total()}}) </h1>
      </div>
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header">
        <a href="{{route('subject.list')}}" class="btn btn-primary">Reset</a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="#" class="text-danger w-4 h-4 mr-1" onclick="deleteSubject({{$subject->id}})">
