...
<section class="content-header">					
  <div class="container-fluid my-2">
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <h1 class="heading">Student List (Total: {{$students->total()}})</h1>
      </div>
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header">
        <a href="{{route('student.list')}}" class="btn btn-primary">Reset</a>
            ...
            <tr>
              ...
              <td> 
                <span><strong>Name : </strong> {{$student->name}} {{$student->last_name}}  | 
                   <strong>Parent Name : </strong> {{$student->parent_name}} {{$student->parent_lastName}} </span><br>
              ...
              <td>
                ...
                <a href="javascript:void(0);" class="text-danger w-4 h-4 mr-1" onclick="deleteStudent({{$student->id}})">
